...
const Testimonials = () => {
  return (
    <section className="bg-gray-50 dark:bg-gray-400 py-16 transition-colors">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow hover:shadow-md dark:hover:shadow-lg transition text-left"
            >
              <Quote
              ...
              <div className="flex items-center gap-4">
                {testimonial.image && (
                  <Image
                    ...
                    width={30}
                    height={30}
                    className="rounded-full object-cover border w-16"
                  />
                )}
                <div>
