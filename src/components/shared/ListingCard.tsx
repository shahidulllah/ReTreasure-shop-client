...
const ListingCard = ({ listing }: ListingCardProps) => {
  return (
    ...
    >
      ...
      <div className="p-4">
        <p className="text-red-600 font-bold text-lg">{listing.price} <span className="font-extrabold">৳</span></p>
        ...
        <p className="text-xs text-gray-400 mt-2">{getTimeAgo(listing.createdAt)}</p>
      </div>
    </div>
  );
};
